				...
				<div class="row">
					...
					<div class="grid_3 ">
						<div class="banner1 vline">
							...
							<p class="txt1 wow fadeInUp" data-wow-delay="0.5s">Cama y <br>desayuno, <br>paquete</p>
							<p class="txt2 wow fadeInUp" data-wow-delay="0.6s">VER NUESTRA PROMOCIÓN</p>
							<a href="#" class="more_btn wow fadeInUp" data-wow-delay="0.7s">Leer mas..</a>
						</div>
					</div>
					...
					<div class="grid_3 ">
						<div class="banner1 vline">
							...
							<p class="txt1 wow fadeInUp" data-wow-delay="0.9s">Hotel y<br>Restaurante</p>
							<p class="txt2 wow fadeInUp" data-wow-delay="1.0s">MENÚ PERFECTO DE NUESTRO COCINERO</p>
					...
					<div class="grid_3 ">
						<div class="banner1">
							...
							<a href="google.com" target="_blank" class="more_btn wow fadeInUp" data-wow-delay="1.9s">Descargar 1</a>
							<a href="google.com" target="_blank" class="more_btn wow fadeInUp" data-wow-delay="1.9s">Descargar 2</a>
						</div>
					</div>
		...
		<div class="container txt_cntr wow fadeInUp">
			...
			<div class="row">
				<div class="grid_4" data-wow-duration="" data-wow-delay="0.4s">
					<h2 class="vline2">PAQUETES FAMILIARES</h2>
					<h3>Desde $85</h3>
				...
				<div class="grid_4" data-wow-duration="" data-wow-delay="0.6s">
					<h2 class="vline2">paquetes de negocios</h2>
					<h3>DESDE $120</h3>
					<div class="hline2"></div>
					<a href="#" class="banner2">
