<?php	
	...
	if($_GET['fn'] == '0'){//function atras
		...
		$sql = "select usuario.id,id_hotel,nombre_usuario,tipo_identificacion,identificacion,telefono,celular,email,usuario,estado,fecha,id_ciudad,nombre_ciudad,id_cargo,nombre_cargo,extranjero,imagen,direccion,clave from usuario,ciudad,cargo,clave where usuario.id_cargo = cargo.id and usuario.id_ciudad = ciudad.id and usuario.id = clave.id_usuario and usuario.id = '".$id_tabla."'";								
