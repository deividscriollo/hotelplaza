...
function inicio (){
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	        
	        ...
	        colNames: ['ID','id_hotel','NOMBRES','tipo_identificacion','CI','TELÉFONO','CELULAR','E-MAIL','USUARIO','ESTADO','FECHA','id_ciudad','CIUDAD','id_cargo','CARGO','EXTRANJERO','imagen','DIRECCION','clave','estado'],
	        colModel:[      
