								...
								<div class="widget-box">
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="row">
												<form class="form-horizontal" role="form" rol="form" action="" method="POST" id="form_clientes">												
													<div class="row">
														<div class="col-xs-12">
															<div class="col-xs-2">
																	...
																	<div class="col-xs-12">
																		<div class="col-xs-12">																									
																			<span class="profile-picture">
																				<img id="avatar" name="avatar" class="editable img-responsive" alt="Clientes x" src="img/default.png" accept="image/*"/>
																			</span>
																		</div>
																	</div>
																</div>
															...
															<div class="col-sm-5">
																<div class="form-group">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_1"> Tipo: </label>
																	<div class="col-sm-9">
																...
																<div class="form-group has-error">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_2"> Dcoumento:</label>
																	<div class="col-sm-9">
																		<input type="text" id="txt_2" name="txt_2"  placeholder="Identificación" class="form-control" data-toggle="tooltip" data-original-title="Agregue el nro de CI en caso de ser extranjero seleccione la casilla Passaporte" required pattern="[0-9]{10,10}" maxlength="10" />
																		<input type="hidden" id="txt_o" name="txt_o" />
																	</div>
																</div>

																<div class="form-group has-error">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_2"> Nombres: </label>
																	<div class="col-sm-9">
																...
																<div class="form-group has-error">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_4"> Apellidos: </label>
																	<div class="col-sm-9">
																		<input type="text" id="txt_4" name="txt_4" placeholder="Apellidos" class="form-control" required pattern="[A-Za-záéíóúÁÉÍÓÚñÑ0-9 ]{1,}" data-toggle="tooltip" data-original-title="Apellidos"  />
																	</div>
																</div>
																<div class="form-group has-error">
																...
																<div class="form-group has-error">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_12"> Password: </label>
																	<div class="col-sm-9">
																		<input type="password" id="txt_12" name="txt_12" placeholder="Password" class="form-control" required pattern="[A-Za-záéíóúÁÉÍÓÚñÑ0-9]{6,}" data-toggle="tooltip" data-original-title="Digite la contraseña del cliente mínimo 6 carácteres"/>
																	</div>
																</div>
															</div>
															...
															<div class="col-sm-5">
																<div class="form-group">
																	<label class="col-sm-3 control-label no-padding-right" for="txt_6"> Teléfono: </label>
																	<div class="col-sm-9">	
																		<span class="block input-icon input-icon-right">
																			<input type="text" id="txt_6" name="txt_6" placeholder="Teléfono" class="form-control" onkeydown="return validarNumeros(event)" />
																...
																<div class="form-group has-error">
																	...
																	<div class="col-sm-9">																	  
																	  	<input type="email" id="txt_8" name="txt_8" placeholder="Correo" class="form-control" required pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"  data-toggle="tooltip" data-original-title="Cuenta de Correo Electrónico" />
																	</div>
																</div>
